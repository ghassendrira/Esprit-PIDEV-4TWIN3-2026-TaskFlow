...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ai/expense-classifier', loadComponent: () => import('./features/ai/expense-classifier.component').then(m => m.ExpenseClassifierComponent) },
      { path: 'ai/invoice-delay', loadComponent: () => import('./features/ai/invoice-delay-risk.component').then(m => m.InvoiceDelayRiskComponent) },
      ...
      },
      {
        ...
        canActivate: [roleGuard],
        data: { roles: ['SUPER_ADMIN', 'ADMIN'] as any },
