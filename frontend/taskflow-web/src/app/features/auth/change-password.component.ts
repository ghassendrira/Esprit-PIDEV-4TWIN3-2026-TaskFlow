...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, NgIf, NgStyle, TranslatePipe],
  template: `
      ...
      >
        ...
        >
          <span class="inline-flex items-center gap-2">
            <span>🔐</span>
            <span>{{ 'change.please-change' | t }}</span>
          </span>
        </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <button
                ...
                [attr.aria-label]="showCurrentPwd ? ('common.hide-password' | t) : ('common.show-password' | t)"
          ...
          <div>
            ...
            <div class="relative">
              ...
              <button
                ...
                [attr.aria-label]="showNewPwd ? ('common.hide-password' | t) : ('common.show-password' | t)"
                class="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--tf-muted)] hover:text-[var(--tf-on-surface)] transition-colors duration-200 cursor-pointer"
              >
          ...
          <div>
            ...
            <div class="relative">
              ...
              <button
                ...
                [attr.aria-label]="showConfirmPwd ? ('common.hide-password' | t) : ('common.show-password' | t)"
                class="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--tf-muted)] hover:text-[var(--tf-on-surface)] transition-colors duration-200 cursor-pointer"
              >
    ...
    (async () => {
      try {
        ...
        if (!email || !fullName || !userId) {
          throw new Error(this.language.translate('common.unknown-error'));
        }
        ...
        this.successMessage =
          this.language.translate('change.success');
        setTimeout(() => {
          this.router.navigateByUrl('/settings');
        }, 1200);
      } catch (err: any) {
        const msg = err?.error?.message ?? err?.message ?? this.language.translate('change.error');
