...
@Component({
  ...
  styles: [`
    ...
    .panel { position: relative; width: min(600px, 92vw); background: #fff; border-radius: 12px; border: 1px solid var(--tf-border); box-shadow: var(--tf-shadow); overflow: hidden; animation: zoomIn .18s ease; }
