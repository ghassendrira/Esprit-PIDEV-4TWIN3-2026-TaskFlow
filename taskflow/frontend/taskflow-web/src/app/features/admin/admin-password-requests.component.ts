  ...
  template: `
    <div class="min-h-[calc(100vh-4rem)] p-6 bg-[var(--tf-surface)] text-[color:var(--tf-on-surface)]">
      ...
      >
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-[color:var(--tf-muted)] mt-1">Manual password reset requests from users</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="text-sm text-[color:var(--tf-muted)] mt-1">All password recovery requests are processed.</div>
      </div>
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <div class="text-xs text-[color:var(--tf-muted)] mt-1">Requested {{ r.requestedAt | date:'medium' }}</div>
            </div>
          </div>
